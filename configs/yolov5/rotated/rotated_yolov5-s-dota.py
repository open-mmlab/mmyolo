...
# ]
anchors = [[(14, 13), (16, 39), (40, 16)], [(24, 79), (84, 24), (54, 54)],
           [(83, 175), (180, 87), (263, 276)]]
strides = [8, 16, 32]
num_det_layers = 3
...
model = dict(
    ...
    neck=dict(
        ...
        act_cfg=dict(type='SiLU', inplace=True)),
    bbox_head=dict(
        type='RotatedYOLOv5Head',
        head_module=dict(
            type='RotatedYOLOv5HeadModule',
    ...
    test_cfg=dict(
        ...
        nms_pre=30000,
        score_thr=0.001,
        nms=dict(type='nms_rotated', iou_threshold=0.10),
        max_per_img=2000))
...
train_pipeline = [
    *pre_transform,
    ...
    dict(type='RegAngle', angle_version='le90'),
    dict(
...
val_evaluator = dict(_scope_='mmrotate', type='DOTAMetric', metric='mAP')
