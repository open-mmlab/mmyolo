...
| YOLOv5-n |  P6  | 1280 |     Yes     |  Yes   | Yes |    x     |   x    | [config](../yolov5/mask_refine/yolov5_n-p6_mask-refine-v62_syncbn_fast_8xb16-300e_coco.py) |                                                                                                                                                                  [model](x) \| [log](x)                                                                                                                                                                  |
...
| YOLOv5-s |  P6  | 1280 |     Yes     |  Yes   | Yes |    x     |   x    | [config](../yolov5/mask_refine/yolov5_s-p6_mask-refine-v62_syncbn_fast_8xb16-300e_coco.py) |                                                                                                                                                                  [model](x) \| [log](x)                                                                                                                                                                  |
...
| YOLOv5-m |  P6  | 1280 |     Yes     |  Yes   | Yes |    x     |   x    | [config](../yolov5/mask_refine/yolov5_m-p6_mask-refine-v62_syncbn_fast_8xb16-300e_coco.py) |                                                                                                                                                                  [model](x) \| [log](x)                                                                                                                                                                  |
...
| YOLOv5-l |  P6  | 1280 |     Yes     |  Yes   | Yes |    x     |   x    | [config](../yolov5/mask_refine/yolov5_l-p6_mask-refine-v62_syncbn_fast_8xb16-300e_coco.py) |                                                                                                                                                                  [model](x) \| [log](x)                                                                                                                                                                  |
