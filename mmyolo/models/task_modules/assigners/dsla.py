...
class DynamicSoftLabelAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        pairwise_ious = self.iou_calculator(valid_decoded_bbox, gt_bboxes)  # num_priors, num_gts
        iou_cost = -torch.log(pairwise_ious + EPS) * self.iou_weight

        pairwise_pred_scores = valid_pred_scores[:, gt_labels.long()]
        ...
        pairwise_cls_cost = F.binary_cross_entropy_with_logits(
            ...
            reduction='none') * scale_factor.abs().pow(2.0)  # num_priors, num_gts, num_classes
