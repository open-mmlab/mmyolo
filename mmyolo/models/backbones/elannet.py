    ...
    def __init__(self,
        ...
        for i, (in_channels, out_channels, num_blocks, shortcut,
            ...
            conv_layer = self.add_module(
                'layers{}__stage{}__conv_layer'.format(layers_num, i + 1),
                Conv(
            ...
            if use_spp and arch in ['X']:
                ...
                spp_layer = self.add_module(
                    'layers{}__stage{}__spp_layer'.format(layers_num, i + 1),
                    SPPLayer(
                        out_channels,
                        out_channels,
            ...
            csp_layer = self.add_module(
                'layers{}__stage{}__csp_layer'.format(layers_num, i + 1),
                CSPLayer(
                    out_channels,
                    out_channels,
            ...
            if use_spp and arch in ['P5', 'P6']:
                ...
                sppf_layer = self.add_module(
                    'layers{}__stage{}__sppf_layer'.format(layers_num, i + 1),
                    SPPFLayer(
                        out_channels,
                        out_channels,
                        ksize=5,
