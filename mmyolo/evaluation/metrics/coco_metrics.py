...
from mmdet.evaluation.metrics import CocoMetric as MMDetCocoMetric
...
class YOLOPoseCocoMetric(MMDetCocoMetric):
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        for data_sample in data_samples:
            ...
            result['keypoints_visibility'] = pred['keypoints_visibility'].cpu().numpy()
            # encode mask to RLE
            if 'masks' in pred:
