...
from mmyolo.models import CSPResNet
...
class TestPPYOLOECSPResNet(TestCase):
    ...
    def test_forward(self):
        ...
        model = CSPResNet(norm_eval=True)
        model.train()
        ...
        model = CSPResNet(widen_factor=0.125, out_indices=range(0, 5))
