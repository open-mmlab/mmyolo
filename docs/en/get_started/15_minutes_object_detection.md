...
- YOLOv5 is an Anchor-Based algorithm, and different datasets need to adaptively calculate suitable anchors
...
- Due to the dataset is too small, we choose fixed backbone weight
