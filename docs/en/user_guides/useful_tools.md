...
Function 1: Generated by the sub function `def show_bbox_num(cfg, args, fig_set, class_name, class_num)` to display the distribution of categories and bbox instances.

<img src="https://user-images.githubusercontent.com/90811472/196891728-4c2f1ab3-01cb-445f-a6b8-39752387c40f.jpg"/>

Function 2: Generated by the sub function `def show_bbox_wh(args, fig_set, class_bbox_w, class_bbox_h, class_name)` to display the width and height distribution of categories and bbox instances.

<img src="https://user-images.githubusercontent.com/90811472/199019573-650b9652-eb14-4bc0-a5e8-650dfc578fc8.jpg"/>

Function 3: Generated by the sub function `def show_bbox_wh_ratio(args, fig_set, class_name, class_bbox_ratio)` to display the width to height ratio distribution of categories and bbox instances.

<img src="https://user-images.githubusercontent.com/90811472/199019593-0f810a21-18d2-41ac-b4fa-baa8288bcb23.jpg"/>

Function 3: Generated by the sub function `def show_bbox_area(args, fig_set, area_rule, class_name, bbox_area_num)` to display the distribution map of category and bbox instance area based on area rules.

<img src="https://user-images.githubusercontent.com/90811472/199022991-5388db47-d0f3-4201-9eee-13c5fab6bca9.jpg"/>

Print List: Generated by the sub function `def show_class_list(class_name, class_num)`.
