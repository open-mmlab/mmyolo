...
We provide a `script.sh` file for you which runs the whole pipeline. Create the file under `/openmmlab/mmyolo` directory in your docker container using the following content.
